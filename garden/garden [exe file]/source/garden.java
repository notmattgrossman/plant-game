...
public void updateWaterSound(boolean pouring) {
...
public void drawHud(int fullyGrown) {
...
public PVector getSpoutPosition(float canX, float canY) {
  float spoutBaseX = 38;
  float spoutBaseY = -8;
...
public void drawCan(float x, float y) {
  pushMatrix();
  translate(x, y);
...
public void playTwinkleSound(int index) {
